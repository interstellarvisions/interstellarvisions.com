            ...
            <div className="p-8 md:p-14">
              ...
              <div className="text-center">
                <button
                  ...
                  className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold py-4 px-12 rounded-lg transition-all duration-300 hover:scale-105 text-lg tracking-wide"
                >
