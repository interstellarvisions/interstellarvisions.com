...
const projects = [
  {
    ...
    images: [
      ...
      "/images/work/Aurora/3.webp",
      "/images/work/Aurora/4.webp",
      "/images/work/Aurora/5.webp",
      "/images/work/Aurora/6.webp",
      "/images/work/Aurora/7.webp",
      "/images/work/Aurora/8.webp",
    ],
  },
  {
    id: 2,
    ...
    images: [
      ...
      "/images/work/Amber/3.webp",
      "/images/work/Amber/4.webp",
      "/images/work/Amber/5.webp",
      "/images/work/Amber/6.webp",
      "/images/work/Amber/7.webp",
      "/images/work/Amber/8.webp",
...
function ChromeProjectCard({ project, index, onClick }: { project: typeof projects[0]; index: number; onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute bottom-0 left-0 right-0 p-6">
        <h3 className="text-2xl font-bold tracking-wider transition-colors duration-300" style={{ color: hovered ? "#67e8f9" : "#ffffff" }}>
          {project.title}
        </h3>
        ...
        <div className="text-center mb-16 md:mb-20">
          {isSafari ? (
            ...
            <motion.h2
              ...
              className="text-5xl md:text-7xl font-bold tracking-wider mb-4 shimmer-work"
            >
              OUR WORK
            </motion.h2>
          )}
