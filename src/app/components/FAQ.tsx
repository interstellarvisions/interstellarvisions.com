  ...
  return (
    <section id="faq" className="py-24 md:py-32 px-6 relative bg-gradient-to-b from-black to-slate-900">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-500 text-sm tracking-[0.2em] uppercase mb-16 md:mb-24">Everything you need to know</p>
        <div ref={ref} className="space-y-0">
          {faqs.map((faq, index) => (
            <FAQItem key={index} faq={faq} index={index} isOpen={openIndex === index} onToggle={() => setOpenIndex(openIndex === index ? null : index)} isVisible={isInView} />
          ))}
        </div>
      </div>
    </section>
