      ...
      <div className="max-w-[1000px] mx-auto px-6 py-16 relative z-10">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          <section>
            ...
            <p>Welcome to Interstellar Visions ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Communication preferences and feedback about our services</li>
              <li>Project requirements and creative briefs you submit to us</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Process your requests and communicate with you about our services</li>
              <li>Send you technical notices and support messages</li>
              <li>Respond to your comments, questions, and provide customer service</li>
              <li>Develop new features and enhance the AI content creation experience</li>
          ...
          <section>
            ...
            <p>Any content you provide for AI processing is used solely for creating your requested deliverables. We do not use your project data to train our AI models without your explicit consent. All client projects are kept confidential and secure.</p>
          </section>
